-- V044: Add missing columns discovered by schema audit
-- These columns exist in queries but were missing from migrations.

-- 1. check_events: add agent_id and stderr columns
ALTER TABLE check_events ADD COLUMN agent_id UUID;
...
ALTER TABLE gateway_status_events ADD COLUMN agent_id UUID;
