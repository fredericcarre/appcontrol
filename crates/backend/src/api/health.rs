...
static PROMETHEUS_HANDLE: std::sync::OnceLock<&'static metrics_exporter_prometheus::PrometheusHandle> =
...
pub async fn metrics() -> (StatusCode, [(axum::http::header::HeaderName, &'static str); 1], String) {
...
pub async fn openapi_spec() -> (StatusCode, [(axum::http::header::HeaderName, &'static str); 1], &'static str) {
    (
        StatusCode::OK,
