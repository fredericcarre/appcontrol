...
**Product:** AppControl
**Version:** v1.14.0
**Build date:** 2026-04-17 07:33 UTC
**Commit:** `e4abcd4a373d7fe667b0e1dc4ada8ac9ef9e21de`
...
| Rust Tests | **PASS** | 278 passed, 0 failed |
...
- **Release build:** PASS
- **Lines of code:** ~90979 LoC across 8 crates
...
- **Reproducible builds:** all binaries built from tagged commit `e4abcd4` in CI
...
*It reflects the state of the codebase at commit `e4abcd4a373d7fe667b0e1dc4ada8ac9ef9e21de` on 2026-04-17 07:33 UTC.*
