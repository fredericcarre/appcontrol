...
**Product:** AppControl
**Version:** v1.18.13
**Build date:** 2026-05-13 16:06 UTC
**Commit:** `85b6f948a81354d528aa0b03b228910d8d2ca036`
...
| Rust Tests | **PASS** | 311 passed, 0 failed |
...
- **Release build:** PASS
- **Lines of code:** ~97309 LoC across 8 crates
...
- **Database migrations:** 106 SQL migration files
- **Binary checksums:** SHA-256 checksums published in `checksums-sha256.txt` with each release
- **Reproducible builds:** all binaries built from tagged commit `85b6f94` in CI
...
*It reflects the state of the codebase at commit `85b6f948a81354d528aa0b03b228910d8d2ca036` on 2026-05-13 16:06 UTC.*
