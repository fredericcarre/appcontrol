...
**Product:** AppControl
**Version:** v1.12.3
**Build date:** 2026-04-16 10:52 UTC
**Commit:** `90de5487382fba9683a93e31ad01318faa715e53`
...
| Rust Formatting (rustfmt) | **FAIL** | Consistent code style |
...
- **Formatting:** FAIL — all files pass `cargo fmt --check`
- **Release build:** PASS
- **Lines of code:** ~90452 LoC across 8 crates
...
- **Reproducible builds:** all binaries built from tagged commit `90de548` in CI
...
*It reflects the state of the codebase at commit `90de5487382fba9683a93e31ad01318faa715e53` on 2026-04-16 10:52 UTC.*
