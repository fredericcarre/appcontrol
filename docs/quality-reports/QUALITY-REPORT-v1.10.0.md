...
**Product:** AppControl
**Version:** v1.10.0
**Build date:** 2026-04-15 06:13 UTC
**Commit:** `f7fa7f7aa03539b4dc0d464da711b8e92eb8b81f`
...
| Frontend Linting (ESLint) | **FAIL** | TypeScript strict mode |
...
- **Build:** PASS
- **Lines of code:** ~32046 LoC, 123 components
...
- **Reproducible builds:** all binaries built from tagged commit `f7fa7f7` in CI
...
*It reflects the state of the codebase at commit `f7fa7f7aa03539b4dc0d464da711b8e92eb8b81f` on 2026-04-15 06:13 UTC.*
