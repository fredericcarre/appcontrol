...
**Product:** AppControl
**Version:** v1.10.1
**Build date:** 2026-04-15 13:01 UTC
**Commit:** `c633dce5891c2eba34b882b3dd58a77b3562a490`
...
- **Release build:** PASS
- **Lines of code:** ~89513 LoC across 8 crates
...
- **Build:** PASS
- **Lines of code:** ~32044 LoC, 123 components
...
- **Reproducible builds:** all binaries built from tagged commit `c633dce` in CI
...
*It reflects the state of the codebase at commit `c633dce5891c2eba34b882b3dd58a77b3562a490` on 2026-04-15 13:01 UTC.*
