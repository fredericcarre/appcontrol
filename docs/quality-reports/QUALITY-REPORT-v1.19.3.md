...
**Product:** AppControl
**Version:** v1.19.3
**Build date:** 2026-05-14 13:52 UTC
**Commit:** `01349ab0b8c40c96c4895ba51887b403b8bb8fc6`
...
| Rust Tests | **PASS** | 336 passed, 0 failed |
| Frontend Tests | **PASS** | 238 passed, 0 failed |
| Dependency Vulnerabilities (Rust) | **PASS** | 0
0 advisories |
...
- **Release build:** PASS
- **Lines of code:** ~99046 LoC across 9 crates
...
- **Build:** PASS
- **Lines of code:** ~35057 LoC, 128 components
...
- **Database migrations:** 108 SQL migration files
- **Binary checksums:** SHA-256 checksums published in `checksums-sha256.txt` with each release
- **Reproducible builds:** all binaries built from tagged commit `01349ab` in CI
...
*It reflects the state of the codebase at commit `01349ab0b8c40c96c4895ba51887b403b8bb8fc6` on 2026-05-14 13:52 UTC.*
