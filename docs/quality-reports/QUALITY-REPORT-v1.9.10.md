...
**Product:** AppControl
**Version:** v1.9.10
**Build date:** 2026-04-14 09:35 UTC
**Commit:** `f62f504b497ca82e128c43dfb97c65a0db879fde`
...
| Dependency Vulnerabilities (npm) | **FAIL** | Critical: 1, High: 0 |
| Supply Chain (cargo-deny) | **PASS** | Advisory DB + trusted sources |
| Secret Scanning | **FAIL** | 1 findings |
...
- **Reproducible builds:** all binaries built from tagged commit `f62f504` in CI
...
*It reflects the state of the codebase at commit `f62f504b497ca82e128c43dfb97c65a0db879fde` on 2026-04-14 09:35 UTC.*
