...
**Product:** AppControl
**Version:** v1.17.2
**Build date:** 2026-04-24 11:01 UTC
**Commit:** `2fa908f7f8db2ae96fbb9aded88ab9b5da5d68fd`
...
- **Release build:** PASS
- **Lines of code:** ~93784 LoC across 8 crates
...
- **Build:** PASS
- **Lines of code:** ~32990 LoC, 124 components
...
- **Reproducible builds:** all binaries built from tagged commit `2fa908f` in CI
...
*It reflects the state of the codebase at commit `2fa908f7f8db2ae96fbb9aded88ab9b5da5d68fd` on 2026-04-24 11:01 UTC.*
