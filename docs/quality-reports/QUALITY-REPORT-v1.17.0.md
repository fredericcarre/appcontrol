...
**Product:** AppControl
**Version:** v1.17.0
**Build date:** 2026-04-24 03:48 UTC
**Commit:** `36f54a602b294ae7a7d832d552cf166bfd9bfb9c`
...
- **Release build:** PASS
- **Lines of code:** ~93746 LoC across 8 crates
...
- **Database migrations:** 94 SQL migration files
- **Binary checksums:** SHA-256 checksums published in `checksums-sha256.txt` with each release
- **Reproducible builds:** all binaries built from tagged commit `36f54a6` in CI
...
*It reflects the state of the codebase at commit `36f54a602b294ae7a7d832d552cf166bfd9bfb9c` on 2026-04-24 03:48 UTC.*
