...
**Product:** AppControl
**Version:** v1.11.0
**Build date:** 2026-04-15 20:34 UTC
**Commit:** `db1687cde1cb4fda7fbf93aafefd4fb58afa99af`
...
- **Reproducible builds:** all binaries built from tagged commit `db1687c` in CI
...
*It reflects the state of the codebase at commit `db1687cde1cb4fda7fbf93aafefd4fb58afa99af` on 2026-04-15 20:34 UTC.*
