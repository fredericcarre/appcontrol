...
**Product:** AppControl
**Version:** v1.17.1
**Build date:** 2026-04-24 10:07 UTC
**Commit:** `fff1e0b21f921d084db8ac1b93bc55378c7317a8`
...
- **Reproducible builds:** all binaries built from tagged commit `fff1e0b` in CI
...
*It reflects the state of the codebase at commit `fff1e0b21f921d084db8ac1b93bc55378c7317a8` on 2026-04-24 10:07 UTC.*
