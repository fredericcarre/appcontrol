...
**Product:** AppControl
**Version:** v1.17.3
**Build date:** 2026-05-04 10:25 UTC
**Commit:** `21211f541b8213604ba501a674d3fb7ef5c20633`
...
| Rust Tests | **PASS** | 302 passed, 0 failed |
...
- **Release build:** PASS
- **Lines of code:** ~93897 LoC across 8 crates
...
- **Build:** PASS
- **Lines of code:** ~33116 LoC, 124 components
...
- **Database migrations:** 96 SQL migration files
- **Binary checksums:** SHA-256 checksums published in `checksums-sha256.txt` with each release
- **Reproducible builds:** all binaries built from tagged commit `21211f5` in CI
...
*It reflects the state of the codebase at commit `21211f541b8213604ba501a674d3fb7ef5c20633` on 2026-05-04 10:25 UTC.*
