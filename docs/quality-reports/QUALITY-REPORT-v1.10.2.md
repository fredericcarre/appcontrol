...
**Product:** AppControl
**Version:** v1.10.2
**Build date:** 2026-04-15 14:04 UTC
**Commit:** `d40dd457eeb00e6a703ca09d5267b00a3ca1c0cc`
...
- **Release build:** PASS
- **Lines of code:** ~89583 LoC across 8 crates
...
- **Build:** PASS
- **Lines of code:** ~32121 LoC, 123 components
...
- **Reproducible builds:** all binaries built from tagged commit `d40dd45` in CI
...
*It reflects the state of the codebase at commit `d40dd457eeb00e6a703ca09d5267b00a3ca1c0cc` on 2026-04-15 14:04 UTC.*
