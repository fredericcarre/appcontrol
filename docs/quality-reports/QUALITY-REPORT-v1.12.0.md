...
**Product:** AppControl
**Version:** v1.12.0
**Build date:** 2026-04-15 21:38 UTC
**Commit:** `ca3502dae9ea3e915b2ed0bcd7608061ce3aaeeb`
...
- **Reproducible builds:** all binaries built from tagged commit `ca3502d` in CI
...
*It reflects the state of the codebase at commit `ca3502dae9ea3e915b2ed0bcd7608061ce3aaeeb` on 2026-04-15 21:38 UTC.*
